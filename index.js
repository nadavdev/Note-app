let notes = [
  {
    id: new Date(),
    title: "Sample Note",
    body: "This is a descreptive for our sample note",
    bgColor: "pink",
  },
];
...
const editNote = (noteDiv, editSave = false) => {
  ...
  deleteButton.innerHTML = 'Cancle Edit';
